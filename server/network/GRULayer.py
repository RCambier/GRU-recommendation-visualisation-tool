...
class GRULayer(MergeLayer):
    ...
    def get_output_and_gates_for(self, inputs, **kwargs):
        """
        ...
        def step(input_n, hid_previous, *args):
            ...
            return hid,resetgate,updategate, hidden_update

        def step_masked(input_n, mask_n, hid_previous, *args):
            hid, resetgate, updategate, hidden_update = step(input_n, hid_previous, *args)
        ...
        if self.unroll_scan:
            ...
            outputs = unroll_scan(
                fn=step_fun,
                sequences=sequences,
                outputs_info=[hid_init,None,None, None],
        ...
        [hid_out, resetgate, updategate, hidden_update] = outputs
        ...
        return [hid_out, resetgate, updategate,hidden_update]
